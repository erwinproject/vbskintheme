        ...
        For I As Integer = 0 To TabPages.Count - 1
            ...
            If String.IsNullOrEmpty(TabPages(I).Tag) Then
                ...
                If SelectedIndex = I Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#2B2F33")), TextColor As New SolidBrush(ColorFromHex("#BECCD9")), TextFont As New Font("Tahoma", 9)
                ...
                Else
                    ...
                    Using TextColor As New SolidBrush(ColorFromHex("#919BA6")), TextFont As New Font("Tahoma", 9)
                        G.DrawString(TabPages(I).Text, TextFont, TextColor, New Point(Rect.X + 50 + (ItemSize.Height - 180), Rect.Y + 12))
                    End Using
                ...
                If Not OverIndex = -1 And Not SelectedIndex = OverIndex Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#2F3338")), TextColor As New SolidBrush(ColorFromHex("#919BA6")), TextFont As New Font("Tahoma", 9)
            ...
            Else
                ...
                Using TextColor As New SolidBrush(ColorFromHex("#6A7279")), TextFont As New Font("Tahoma", 7, FontStyle.Bold), Border As New Pen(ColorFromHex("#2B2F33"))
...
Public Class AetherGroupBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using P1 As New Pen(ColorFromHex("#5B5B5B")), B1 As New SolidBrush(ColorFromHex("#343843")), F1 As New Font("Segoe UI", 9)
