...
#End Region
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            'WARNA KUNING
            G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), New Rectangle(0, 0, Width, 60))
            ...
            If _RoundCorners = True Then
                ...
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), 1, 3, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), 1, 2, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), 2, 1, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), 3, 1, 1, 1)
                ...
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), Width - 2, 3, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), Width - 2, 2, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), Width - 3, 1, 1, 1)
                G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), Width - 4, 1, 1, 1)
...
#End Region
        ...
        Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            MyBase.OnPaint(e)
            Dim G As Graphics = e.Graphics
            G.Clear(Color.FromArgb(181, 179, 42))
...
#End Region
        ...
        Sub New()
            ...
            P1 = New Pen(Color.FromArgb(181, 179, 42)) ' P1 = Border color
            P3 = New Pen(Color.FromArgb(165, 157, 37))  ' P3 = Border color when pressed
        End Sub
        ...
        Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
            ...
            If Width > 0 AndAlso Height > 0 Then
                ...
                InactiveGB = New LinearGradientBrush(New Rectangle(0, 0, Width, Height), Color.FromArgb(181, 179, 42), Color.FromArgb(181, 179, 42), 90.0F)
                PressedGB = New LinearGradientBrush(New Rectangle(0, 0, Width, Height), Color.FromArgb(165, 157, 37), Color.FromArgb(165, 157, 37), 90.0F)
            End If
...
#Region " EventArgs "
        ...
        Protected Overrides Sub OnMouseEnter(e As EventArgs)
            ...
            EllipseColor = Color.FromArgb(181, 179, 42)
            Refresh()
        End Sub
...
#Region " Link Label "
    Class MonoFlat_LinkLabel
        ...
        Sub New()
            ...
            BackColor = Color.Transparent
            LinkColor = Color.FromArgb(181, 179, 42)
            ActiveLinkColor = Color.FromArgb(153, 34, 34)
            VisitedLinkColor = Color.FromArgb(181, 179, 42)
        ...
        Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
            ...
            With G
                ...
                If _Toggled Then
                    ...
                    GP2 = RoundRect(ThumbRect, 4)
                    .FillPath(New SolidBrush(Color.FromArgb(181, 179, 42)), GP)
                    .FillPath(New SolidBrush(Color.FromArgb(32, 41, 50)), GP2)
                End If
                ...
                Select Case ToggleType
                    ...
                    Case _Type.OnOff
                        If Toggled Then
                            G.DrawString("ON", New Font("Tahoma", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        Else
                            G.DrawString("OFF", New Font("Tahoma", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 57, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        End If
                    Case _Type.YesNo
                        If Toggled Then
                            G.DrawString("YES", New Font("Tahoma", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 19, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        Else
                            G.DrawString("NO", New Font("Tahoma", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 56, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        End If
                    Case _Type.IO
                        If Toggled Then
                            G.DrawString("I", New Font("Tahoma", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        Else
                            G.DrawString("O", New Font("Tahoma", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 57, Bar.Y + 16, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                        End If
                End Select
            End With
        End Sub
...
#End Region
        ...
        Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            ...
            If Enabled = True Then
                If _Checked Then G.DrawString("a", New Font("Marlett", 16), New SolidBrush(Color.FromArgb(181, 179, 42)), New Point(-5, -3))
            Else
...
#End Region
        ...
        Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            ...
            If _Checked Then
                G.DrawString("a", New Font("Marlett", 15), New SolidBrush(Color.FromArgb(181, 179, 42)), New Point(-3, -2))
            End If
...
#Region " EventArgs "
        ...
        Private Sub _Enter(ByVal Obj As Object, ByVal e As EventArgs)
            P1 = New Pen(Color.FromArgb(181, 179, 42))
            Refresh()
        End Sub
...
#Region " Panel "
    ...
    Class MonoFlat_Panel
        ...
        Sub New()
            ...
            BackColor = Color.FromArgb(51, 55, 59)
        ...
        Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
            ...
            G.FillPath(New SolidBrush(Color.FromArgb(51, 55, 59)), Shape) ' Draw RTB background
            G.DrawPath(New Pen(Color.FromArgb(51, 55, 59)), Shape) ' Draw border
...
#End Region
        ...
        Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
            ...
            G.FillRectangle(New SolidBrush(Color.FromArgb(181, 179, 42)), FillValue)

            G.ResetClip()

            G.SmoothingMode = SmoothingMode.HighQuality
            G.FillEllipse(New SolidBrush(Color.FromArgb(181, 179, 42)), TrackThumb.X + CInt(TrackThumb.Width * (Value / Maximum)) - CInt(ThumbSize.Width / 2), TrackThumb.Y + CInt((TrackThumb.Height / 2)) - CInt(ThumbSize.Height / 2), ThumbSize.Width, ThumbSize.Height)
            G.DrawEllipse(New Pen(Color.FromArgb(181, 179, 42)), TrackThumb.X + CInt(TrackThumb.Width * (Value / Maximum)) - CInt(ThumbSize.Width / 2), TrackThumb.Y + CInt((TrackThumb.Height / 2)) - CInt(ThumbSize.Height / 2), ThumbSize.Width, ThumbSize.Height)
        End Sub
    End Class
